...
object GBDT {
  def main(args: Array[String]) {
    ...
    val nbaRDD = spark.sparkContext.textFile("/Users/santrao/work/spike/spark/spark_nlp/data/nba.txt")
    ...
    val ngram = new NGram().setInputCol(tokenizer.getOutputCol).setOutputCol("ngrams")
